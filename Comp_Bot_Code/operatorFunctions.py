...
class operatorFunctions():
    MIN_LIFT_HEIGHT = 0#Value in encoder codes
    MAX_LIFT_HEIGHT = 10000000000#Value in encoder codes
    ...
    def __init__(self, robot, drive):
        ...
        self.winchMotorOne.setNeutralMode(2)
        self.winchMotorTwo.setNeutralMode(2)
        self.winchMotorThree.setNeutralMode(2)
        ...
        self.toggle = 0#Initilizes manipulator toggle to an off state
    ...
    def operate(self, leftY, leftX, rightY, rightX, aButton, bButton, xButton, yButton, rightTrigger,rightBumper, leftTrigger, leftBumper, startButton, backButton):
        ...
        #self.liftTilt(rightBumper, leftBumper)#Not on practice base
